    ...
    <div className='p-6 md:p-10 border rounded-xl shadow-sm mt-5 bg-white'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center'>
        ...
        <div className='space-y-4'>
          <h2 className='font-bold text-2xl md:text-3xl'>{course?.courseOutput?.course?.name || "Course Name"} <EditCourseBasicInfo course={course} refreshData={()=>refreshData(true)}/></h2>
